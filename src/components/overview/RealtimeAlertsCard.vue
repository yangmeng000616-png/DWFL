  ...
  <div class="tech-panel rounded-xl p-2 flex flex-col justify-between h-full shadow-[0_4px_20px_rgba(0,0,0,0.5)] border border-[#1b4382]/80">
    ...
    <div class="flex items-center justify-between pb-1.5 border-b border-[#184682]/60 flex-shrink-0">
      <div class="flex items-center gap-1.5">
        ...
        <div class="flex items-center gap-1.5">
          <h3 class="text-xs sm:text-sm font-bold text-white tracking-wide">实时告警</h3>
    ...
    <!-- 2. 统计概览条 (极简风险等级 + 闭环概况) -->
    <div class="py-1 px-1.5 my-1 bg-[#06152e]/85 rounded-lg border border-[#1a447c]/60 flex items-center justify-between flex-shrink-0 text-[10px]">
      <div class="flex items-center gap-2">
        <span class="text-slate-400 font-medium">风险:</span>
      ...
      <div class="text-slate-400 text-[9.5px]">
        今日 <strong class="text-slate-200 font-mono">7</strong> · 闭环率 <strong class="text-emerald-300 font-mono">57%</strong>
      </div>
    </div>
